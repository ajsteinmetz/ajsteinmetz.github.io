...
[^4]: More explicitly, if $$u=s^2/(4z^2)$$, then $$(1-u)^{-2}=1+2u+3u^2+\cdots$$ for $$\lvert u\rvert < 1$$. Keeping only the leading term gives the far-field approximation used here.
